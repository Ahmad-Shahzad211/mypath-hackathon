...
const Navbar = () => {
  ...
  return (
    <header className="fixed w-full z-10 bg-white dark:bg-dark-text-hover lg:bg-transparent dark:lg:bg-transparent flex justify-between items-center p-2 lg:p-4 shadow-md md:shadow-none">
